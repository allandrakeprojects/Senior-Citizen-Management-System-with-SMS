        ...
        fSelect.prototype = {
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-option.selected').each(function(i, el) {
                    ...
                    labelId.push($(el).attr('data-value'));
                    labelBirthday.push($(el).attr('data-value') + '||' + $(el).find('.fs-option-label').html());
                });
                ...
                this.$wrap.find('.fs-label').html('Select');
                if(labelText == 'Select'){
                    $('#select_seniors').html('None Selected');
                    $('#select_seniors_hidden').val('None Selected');
                    $('#select_seniors_birthday').val('None Selected');
                } else {
                    $('#select_seniors').html(labelText);
                    $('#select_seniors_hidden').val(labelId);
                    $('#select_seniors_birthday').val(labelBirthday);
                }
